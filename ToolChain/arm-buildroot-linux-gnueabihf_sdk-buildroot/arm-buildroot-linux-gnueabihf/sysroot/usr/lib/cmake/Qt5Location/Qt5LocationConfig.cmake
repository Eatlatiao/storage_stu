...
set(Qt5Location_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/qt5/QtLocation/5.12.8"
        "${_qt5Location_install_prefix}/include/qt5/QtLocation/5.12.8/QtLocation"
    )
    ...
    foreach(_module_dep ${_Qt5Location_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5Location_FIND_VERSION_EXACT}
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location.so.5.12.8" "" )
    ...
    macro(_populate_Location_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Location_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Location_check_file_exists(${imported_location})
