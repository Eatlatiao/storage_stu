...
set(Qt5VirtualKeyboard_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(_Qt5VirtualKeyboard_OWN_INCLUDE_DIRS "${_qt5VirtualKeyboard_install_prefix}/include/qt5/" "${_qt5VirtualKeyboard_install_prefix}/include/qt5/QtVirtualKeyboard")
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/qt5/QtVirtualKeyboard/5.12.8"
        "${_qt5VirtualKeyboard_install_prefix}/include/qt5/QtVirtualKeyboard/5.12.8/QtVirtualKeyboard"
    )
    ...
    foreach(_module_dep ${_Qt5VirtualKeyboard_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5VirtualKeyboard_FIND_VERSION_EXACT}
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "libQt5VirtualKeyboard.so.5.12.8" "" )
    ...
    macro(_populate_VirtualKeyboard_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5VirtualKeyboard_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_VirtualKeyboard_check_file_exists(${imported_location})
