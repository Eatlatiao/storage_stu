...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Scxml" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Scxml_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5Scxml_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(_Qt5Scxml_OWN_INCLUDE_DIRS "${_qt5Scxml_install_prefix}/include/qt5/" "${_qt5Scxml_install_prefix}/include/qt5/QtScxml")
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/qt5/QtScxml/5.12.8"
        "${_qt5Scxml_install_prefix}/include/qt5/QtScxml/5.12.8/QtScxml"
    )
    ...
    foreach(_module_dep ${_Qt5Scxml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5Scxml_FIND_VERSION_EXACT}
    ...
    _populate_Scxml_target_properties(RELEASE "libQt5Scxml.so.5.12.8" "" )
    ...
    macro(_populate_Scxml_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Scxml_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Scxml_check_file_exists(${imported_location})
