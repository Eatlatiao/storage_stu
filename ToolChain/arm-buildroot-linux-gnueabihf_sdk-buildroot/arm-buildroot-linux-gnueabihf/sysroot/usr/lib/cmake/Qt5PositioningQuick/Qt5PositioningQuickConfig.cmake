...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5PositioningQuick" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5PositioningQuick_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5PositioningQuick_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::PositioningQuick)
    ...
    set(_Qt5PositioningQuick_OWN_INCLUDE_DIRS "${_qt5PositioningQuick_install_prefix}/include/qt5/" "${_qt5PositioningQuick_install_prefix}/include/qt5/QtPositioningQuick")
    set(Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5PositioningQuick_install_prefix}/include/qt5/QtPositioningQuick/5.12.8"
        "${_qt5PositioningQuick_install_prefix}/include/qt5/QtPositioningQuick/5.12.8/QtPositioningQuick"
    )
    ...
    foreach(_module_dep ${_Qt5PositioningQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5PositioningQuick_FIND_VERSION_EXACT}
    ...
    _populate_PositioningQuick_target_properties(RELEASE "libQt5PositioningQuick.so.5.12.8" "" )
    ...
    macro(_populate_PositioningQuick_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5PositioningQuick_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_PositioningQuick_check_file_exists(${imported_location})
