...
set(Qt5WebChannel_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/qt5/QtWebChannel/5.12.8"
        "${_qt5WebChannel_install_prefix}/include/qt5/QtWebChannel/5.12.8/QtWebChannel"
    )
    ...
    foreach(_module_dep ${_Qt5WebChannel_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5WebChannel_FIND_VERSION_EXACT}
    ...
    _populate_WebChannel_target_properties(RELEASE "libQt5WebChannel.so.5.12.8" "" )
    ...
    macro(_populate_WebChannel_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebChannel_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_WebChannel_check_file_exists(${imported_location})
