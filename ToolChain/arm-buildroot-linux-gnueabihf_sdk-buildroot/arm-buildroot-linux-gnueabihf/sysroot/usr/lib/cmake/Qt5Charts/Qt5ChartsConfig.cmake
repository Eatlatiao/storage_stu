...
set(Qt5Charts_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::Charts)
    ...
    set(_Qt5Charts_OWN_INCLUDE_DIRS "${_qt5Charts_install_prefix}/include/qt5/" "${_qt5Charts_install_prefix}/include/qt5/QtCharts")
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/qt5/QtCharts/5.12.8"
        "${_qt5Charts_install_prefix}/include/qt5/QtCharts/5.12.8/QtCharts"
    )
    ...
    foreach(_module_dep ${_Qt5Charts_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5Charts_FIND_VERSION_EXACT}
    ...
    _populate_Charts_target_properties(RELEASE "libQt5Charts.so.5.12.8" "" )
    ...
    macro(_populate_Charts_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Charts_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Charts_check_file_exists(${imported_location})
