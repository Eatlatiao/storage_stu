...
if (CMAKE_VERSION VERSION_LESS 3.1.0)
    message(FATAL_ERROR "Qt 5 WebKit module requires at least CMake version 3.1.0")
endif()
...
set(Qt5WebKit_VERSION_STRING 5.9.1)
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/qt5/QtWebKit/5.9.1"
        "${_qt5WebKit_install_prefix}/include/qt5/QtWebKit/5.9.1/QtWebKit"
    )
    ...
    set(Qt5WebKit_OWN_PRIVATE_INCLUDE_DIRS ${Qt5WebKit_PRIVATE_INCLUDE_DIRS})
    ...
    foreach(_module_dep ${_Qt5WebKit_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.1 ${_Qt5WebKit_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WebKit PROPERTY INTERFACE_QT_ENABLED_FEATURES )
    set_property(TARGET Qt5::WebKit PROPERTY INTERFACE_QT_DISABLED_FEATURES )

    set(_Qt5WebKit_PRIVATE_DIRS_EXIST TRUE)
    foreach (_Qt5WebKit_PRIVATE_DIR ${Qt5WebKit_OWN_PRIVATE_INCLUDE_DIRS})
        if (NOT EXISTS ${_Qt5WebKit_PRIVATE_DIR})
            set(_Qt5WebKit_PRIVATE_DIRS_EXIST FALSE)
        endif()
    endforeach()

    if (_Qt5WebKit_PRIVATE_DIRS_EXIST)
        add_library(Qt5::WebKitPrivate INTERFACE IMPORTED)
        set_property(TARGET Qt5::WebKitPrivate PROPERTY
            INTERFACE_INCLUDE_DIRECTORIES ${Qt5WebKit_OWN_PRIVATE_INCLUDE_DIRS}
        )
        set(_Qt5WebKit_PRIVATEDEPS)
        foreach(dep ${_Qt5WebKit_LIB_DEPENDENCIES})
            if (TARGET ${dep}Private)
                list(APPEND _Qt5WebKit_PRIVATEDEPS ${dep}Private)
            endif()
        endforeach()
        set_property(TARGET Qt5::WebKitPrivate PROPERTY
            INTERFACE_LINK_LIBRARIES Qt5::WebKit ${_Qt5WebKit_PRIVATEDEPS}
        )
    endif()

    _populate_WebKit_target_properties(RELEASE "libQt5WebKit.so.5.9.1" "" )
