...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5SerialBus" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5SerialBus_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5SerialBus_VERSION_STRING 5.12.8)
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(_Qt5SerialBus_OWN_INCLUDE_DIRS "${_qt5SerialBus_install_prefix}/include/qt5/" "${_qt5SerialBus_install_prefix}/include/qt5/QtSerialBus")
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/include/qt5/QtSerialBus/5.12.8"
        "${_qt5SerialBus_install_prefix}/include/qt5/QtSerialBus/5.12.8/QtSerialBus"
    )
    ...
    foreach(_module_dep ${_Qt5SerialBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5SerialBus_FIND_VERSION_EXACT}
    ...
    _populate_SerialBus_target_properties(RELEASE "libQt5SerialBus.so.5.12.8" "" )
    ...
    macro(_populate_SerialBus_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5SerialBus_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_SerialBus_check_file_exists(${imported_location})
